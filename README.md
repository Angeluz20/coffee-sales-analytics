...
5. Os dados são persistidos no banco utilizando operações de insert ou upsert.
6. O backend expõe endpoints para consultas agregadas.
7. O frontend consome essas APIs e exibe dashboards e relatórios.
...
A deduplicação é garantida por índice único composto e upsert via MERGE, permitindo o reprocessamento seguro dos arquivos sem duplicidade de dados.
...
Endpoints responsáveis pelas consultas analíticas do sistema.
```
